    ...
    def _create_tables(self, conn: sqlite3.Connection):
        ...
        conn.execute("""
            CREATE TABLE IF NOT EXISTS segments (
                ...
                end_current_a REAL,
                start_we_potential_v REAL,
                end_we_potential_v REAL,
                start_ce_potential_v REAL,
                end_ce_potential_v REAL,
                capacity_ah REAL,
                energy_wh REAL,
                ...
                for segment in segments:
                    ...
                    conn.execute("""
                        ...
                        (file_id, segment_index, technique_id, technique_name, 
                         ...
                         end_potential_v, start_current_a, end_current_a, 
                         start_we_potential_v, end_we_potential_v, start_ce_potential_v, end_ce_potential_v,
                         capacity_ah, energy_wh, start_timestamp, capacity_cumulative_ah, energy_cumulative_wh,
                    ...
                    """, (
                        ...
                        segment.get('end_current_a'), 
                        segment.get('start_we_potential_v'), segment.get('end_we_potential_v'),
                        segment.get('start_ce_potential_v'), segment.get('end_ce_potential_v'),
                        segment.get('capacity_ah'), segment.get('energy_wh'), segment.get('start_timestamp'),
