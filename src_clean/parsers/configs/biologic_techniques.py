"""
BioLogic Technique Parameter Definitions - Adapted from YADG

Defines parameter structures for BioLogic electrochemical techniques.
Used for parsing technique parameters from MPR settings modules.
...
Original source: YADG project (https://github.com/dgbowl/yadg)
Adapted for electrochemical data analysis platform integration.

Key Functions:
- technique_params_dtypes: Maps technique_id to parameter structures
- param_from_key: Converts parameter keys between formats
- get_resolution: Determines parameter resolution for measurements

.. codeauthor::
    Nicolas Vetsch,
    Peter Kraus,
    Carla Terboven
    Adapted by: Claude Code Integration
